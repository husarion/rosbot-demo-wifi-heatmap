...
def generate_launch_description():
    ...
    slam_toolbox_conf = LaunchConfiguration('slam_toolbox_conf',
                            default=wifi_heatmap_nav2+'/config/slam_toolbox.yaml')
    ...
    return LaunchDescription([
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource([wifi_heatmap_nav2, '/launch/navigation2.launch.py']),
            launch_arguments = {'nav2_conf' : nav2_conf,
                                'use_sim_time' : use_sim_time}.items(),
        ),

        IncludeLaunchDescription(
            PythonLaunchDescriptionSource([wifi_heatmap_nav2, '/launch/slam_toolbox.launch.py']),
